...
_Technologies: JavaScript, Node.js, TDD, Simulators_

_Code: [https://github.com/matheusportela/enigma-machine/](https://github.com/matheusportela/enigma-machine/)_
...
_Technologies: Python, Numpy, OpenAI Gym, Reinforcement Learning, Q-learning, Multiagent Systems, Bayesian Programming_

_Code: [https://github.com/matheusportela/Multiagent-RL](https://github.com/matheusportela/Multiagent-RL)_
...
_Technologies: C++, Python, Assembly, Arduino, ROS, OpenCV, Microsoft Kinect, Xbee, Electronics, Control Systems_

_Code: [https://github.com/unball/ieee-very-small](https://github.com/unball/ieee-very-small)_

In 2010, invited by a friend, I enjoyed the [UnBall Robot Soccer Team](http://equipeunball.com.br/), a university student team with one goal: build robots that can play soccer. I helped developing the AI and Computer Vision systems initially and, in 2014, I assumed the position of Coordinator. My responsibilities included restructuring the team, which was not longer active, and assist the members to build the project from scratch. I have worked in all technical areas, including AI, Computer Vision, Firmware, Communication, Control Systems, Electronics and 3D Printing, besides other areas such as Management, Recruitment and Finances. Since 2014, the team has participated in several national and international competitions and acquired financial stability and a sustainable recruitment process. In 2016, I assisted the UnBall Coordinator by being a Counselor, overseeing the future of the team.

## All Projects

### Lispy (Feb 2018 - May 2018)
_Technologies: Python, Lisp, TDD, Compilers_

_Code: [https://github.com/matheusportela/lispy](https://github.com/matheusportela/lispy)_
...
_Technologies: Blockchain, Ethereum, Solidity, JavaScript, jQuery, HTML, CSS_

_Code: [https://github.com/matheusportela/magic-chain](https://github.com/matheusportela/magic-chain)_
...
_Technologies: Haskell_

_Code: [https://github.com/matheusportela/collatz](https://github.com/matheusportela/collatz)_
...
_Technologies: Python, Arduino, Infrared Sensors, Digital Communications_

_Code: [https://github.com/matheusportela/control-your-laptop](https://github.com/matheusportela/control-your-laptop)_
...
_Technologies: C, Python, Python Extensions_

_Code: [https://github.com/matheusportela/vigenere-cipher](https://github.com/matheusportela/vigenere-cipher) and [https://github.com/matheusportela/caesar-cipher](https://github.com/matheusportela/caesar-cipher)_
...
_Technologies: Distributed Systems, IoT, C_

_Code: [https://github.com/matheusportela/teemeteam](https://github.com/matheusportela/teemeteam)_
...
### Maestro (Sep 2015)
_Technologies: C, C++, Python, Node.js, Arduino, 3D Printers, Servomotors, Myo, GoPro_

_Code: [https://github.com/matheusportela/maestro](https://github.com/matheusportela/maestro)_
...
_Technologies: C++, SDL, Game Development, Particle Physics Simulation, Entity System, Spatial Partitioning_

_Code: [https://github.com/matheusportela/Poiesis](https://github.com/matheusportela/Poiesis)_
...
_Technologies: C#, Unity 3D, Game Development_

_Code: [https://github.com/imota/aMAZEing-experience](https://github.com/imota/aMAZEing-experience)_
...
_Technologies: Python, HTML_

_Code: [https://github.com/matheusportela/simpletable](https://github.com/matheusportela/simpletable)_
...
_Technologies: Python, Numpy, Third-party APIs, Network Security, Computer Networks, Routes, Switches, Web Application Firewalls_
...
_Technologies: C, Assembly, Compilers_

_Code: [https://github.com/matheusportela/sb-assembler](https://github.com/matheusportela/sb-assembler)_
...
_Technologies: Python, Qt, PyQt, Win32 API, Microsoft Speech Recognition, Human-Computer Interfaces, Research_
